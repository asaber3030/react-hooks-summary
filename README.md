...
## 6. useImperativeHandle()
**Usage**: If you have some inputRef `const inputRef = useRef(null)` and you pass it from another component, and suppose you want to add some functionality to this `ref` we can use `useImperativeHandle` to do this. <br />
